...
public partial class TbDuLieuTrungTuyen
{
    ...
    public  DmDoiTuongUuTien? IdDoiTuongUuTienNavigation { get; set; }

    public  DmHinhThucTuyenSinh? IdHinhThucTuyenSinhNavigation { get; set; }

    public  DmKhuVuc? IdKhuVucNavigation { get; set; }
}

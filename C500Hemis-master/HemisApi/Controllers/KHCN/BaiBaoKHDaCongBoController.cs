...
namespace HemisApi.Controllers.KHCN
{
    ...
    public class BaiBaoKHDaCongBoController : ControllerBase
    {
        ...
        {
            return await _context.TbBaiBaoKhdaCongBos
                .Include(e => e.IdNhiemVuKhcnNavigation)
                .Include(e => e.IdTapChiQuocTeNavigation)
                .Include(e => e.IdTapChiTrongNuocNavigation)
                .Include(e => e.IdXepHangQNavigation)
                .ToListAsync();
        }

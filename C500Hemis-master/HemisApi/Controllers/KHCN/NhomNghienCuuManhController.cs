...
namespace HemisApi.Controllers.CTDT
{
    ...
    public class NhomNghienCuuManhController : ControllerBase
    {
        ...
        // GET: api/CanBo
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TbNhomNghienCuuManh>>> GetTbNhomNghienCuuManhs([FromQuery(Name = "search")] string? searchString)
        {
            ...
            return await _context.TbNhomNghienCuuManhs.Where(e => e.MaNhomNghienCuuManh == searchString).ToListAsync();
        }
